...
bool operator==(const ::baxter_core_msgs::CollisionDetectionState_<ContainerAllocator1> & lhs, const ::baxter_core_msgs::CollisionDetectionState_<ContainerAllocator2> & rhs)
{
