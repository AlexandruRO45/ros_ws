...
bool operator==(const ::baxter_core_msgs::DigitalOutputCommand_<ContainerAllocator1> & lhs, const ::baxter_core_msgs::DigitalOutputCommand_<ContainerAllocator2> & rhs)
{
