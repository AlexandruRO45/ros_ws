...
struct EndpointStates_
{
  ...
  _names_type names;
   ...
   typedef std::vector< ::baxter_core_msgs::EndpointState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::baxter_core_msgs::EndpointState_<ContainerAllocator> >> _states_type;
  _states_type states;
...
bool operator==(const ::baxter_core_msgs::EndpointStates_<ContainerAllocator1> & lhs, const ::baxter_core_msgs::EndpointStates_<ContainerAllocator2> & rhs)
{
