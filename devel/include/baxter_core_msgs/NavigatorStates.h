...
struct NavigatorStates_
{
  ...
  _names_type names;
   ...
   typedef std::vector< ::baxter_core_msgs::NavigatorState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::baxter_core_msgs::NavigatorState_<ContainerAllocator> >> _states_type;
  _states_type states;
...
bool operator==(const ::baxter_core_msgs::NavigatorStates_<ContainerAllocator1> & lhs, const ::baxter_core_msgs::NavigatorStates_<ContainerAllocator2> & rhs)
{
