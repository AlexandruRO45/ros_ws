...
echo_and_run cd "/home/alex/ros_ws/src/baxter/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/alex/ros_ws/src/baxter/gazebo_ros_pkgs/gazebo_plugins/setup.py" \
     \
    build --build-base "/home/alex/ros_ws/build/baxter/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
